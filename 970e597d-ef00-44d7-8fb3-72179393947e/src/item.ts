...
export default class SignPost implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    sign.addComponent(new GLTFShape('970e597d-ef00-44d7-8fb3-72179393947e/models/signpost/SignPost_Wood_Double.glb'))
    ...
    signTextTop.addComponent(
      new Transform({
        position: new Vector3(0.4, 1.47, 0.03),
    ...
    signTextLower.addComponent(
      new Transform({
        position: new Vector3(-0.4, 1.37, 0.03),
        rotation: Quaternion.Euler(0, 180, 0),
        scale: new Vector3(0.05, 0.05, 0.05)
      })
    )
