...
export default class Button implements IScript<Props> {
  ...
  clip = new AudioClip('221ca611-e905-43e8-ab98-f627c4287e74/sounds/open.mp3')
  canvas = new UICanvas()
  texture = new Texture('221ca611-e905-43e8-ab98-f627c4287e74/images/scroll.png')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    scroll.addComponent(new GLTFShape('221ca611-e905-43e8-ab98-f627c4287e74/models/Scroll.glb'))
