...
script3.spawn(signpostTree, {"text":" PIXELS   FOR   MADAGASCAR\n\nis a fun and creative way to support reforestation by Eden Projects","fontSize":20}, createChannel(channelId, signpostTree, channelBus))
...
script3.spawn(signpostTree6, {"text":"     CREATE   ART   PLANT   TREES\n      PLANT   TREES   SAVE   LIVES\n\n   bringing creativity and charity together\n      supporting reforestation with Eden Projects","fontSize":20}, createChannel(channelId, signpostTree6, channelBus))
script3.spawn(signpostTree7, {"text":" PIXELS   FOR   MADAGASCAR\n\nsupporting reforestation with Eden Projects","fontSize":20}, createChannel(channelId, signpostTree7, channelBus))
